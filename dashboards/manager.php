            ...
            <div id="page-tavoli" class="page-section active">
                ...
                <div class="filter-tabs">
                    ...
                    <button class="filter-tab" onclick="filtraTavoli('libero', this)">
                        <span class="status-dot dot-libero"></span> Liberi <span class="filter-count"
                            id="count-libero">0</span>
                    </button>
                    <button class="filter-tab" onclick="filtraTavoli('occupato', this)">
                        <span class="status-dot dot-occupato"></span> Occupati <span class="filter-count"
                            id="count-occupato">0</span>
                    </button>
                    <button class="filter-tab" onclick="filtraTavoli('riservato', this)">
                        <span class="status-dot dot-riservato"></span> Riservati <span class="filter-count"
                            id="count-riservato">0</span>
                    </button>
                </div>
