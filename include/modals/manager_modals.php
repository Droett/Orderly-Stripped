...
<div class="modal fade" id="modalModificaTavolo" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content modal-content-custom shadow-lg">
            ...
            <div class="modal-body p-4">
                <form id="form-modifica-tavolo" method="POST" action="manager.php?action=modifica_tavolo">
                    <input type="hidden" id="mod_id_tavolo" name="id_tavolo">
                    <div class="row g-3">
                        <div class="col-12">
                            <label class="small text-muted fw-bold mb-1">Nome</label>
                            <input type="text" id="mod_nome_tavolo" name="nome_tavolo" class="form-control" required>
                        </div>
                        <div class="col-6">
                            <label class="small text-muted fw-bold mb-1">Password</label>
                            <input type="text" id="mod_password" name="password" class="form-control" required>
                        </div>
                        <div class="col-6">
                            <label class="small text-muted fw-bold mb-1">Posti</label>
                            <input type="number" id="mod_posti" name="posti" class="form-control" min="1" max="20">
                        </div>
                        <div class="col-12">
                            <label class="small text-muted fw-bold mb-1">Stato</label>
                            <select id="mod_stato" name="stato" class="form-select">
            ...
            <div class="modal-footer border-0 p-4">
                ...
                <button type="submit" form="form-modifica-tavolo" class="btn btn-dark rounded-pill px-5 fw-bold">Salva Modifiche</button>
            </div>
        </div>
    </div>
</div>
